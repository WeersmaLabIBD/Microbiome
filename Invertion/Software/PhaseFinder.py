...
# this script is modified from Jiang X, Hall AB, et al. 
# Invertible promoters mediate bacterial phase variation, antibiotic resistance, and host adaptation in the gut, Science (2019) DOI: 10.1126/science.aau5238
...
def pipeline_align(args):
    ...
    cmd = '''
    bowtie --chunkmbs 200 -p {core}  -a --best --strata {genome} -1 {fq1} -2 {fq2} -S|\
    ...
    print("******************** Ratio file generate successfully ********************")
