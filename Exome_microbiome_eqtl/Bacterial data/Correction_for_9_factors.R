...
#######################################################################################################
############################# metagenomics data correction for multiple covariates ####################
#######################################################################################################
...
ibd_covariate[ibd_covariate$Sample_ID=="209-6495",c(2,10)]=c("female",25) #add missing info mannually
ibd_covariate[ibd_covariate$Sample_ID=="214-1341",c(2,10)]=c("female",48) #add missing info mannually
ibd_covariate[ibd_covariate$Sample_ID=="214-1709",c(2,10)]=c("female",37) #add missing info mannually
...
# Solution From Alex If the proportion of NAs is not large, say less than 5%, you can replace NAs by variable mean or median. We usually use median
# change phenotype data to 0 or 1 as integer or numeric in R
...
# remove special symbols in pathway names
# match names
...
# caculate pathway relative abundance
# cutoff: 25% present rate in individuals
# log transformation
# match names
...
# cut off based on 10% present rate among samples and arcsin transformation
...
# merge corrected pathway data and corrrected taxa data
